...
namespace Service.DAO
{
    public class DAOBase<T> where T : DTOBase, new()
    {
        ...
        public int Insert(T dto)
        {
            ...
            MongoLogger.InsertarLog(Operacion.INSERT, "WIP", dto, getTableName());
        ...
        public void Update(T dto)
        {
            ...
            MongoLogger.InsertarLog(Operacion.UPDATE, "WIP", dto, getTableName());
        ...
        public void Delete(int id)
        {
            ...
            MongoLogger.InsertarLog(Operacion.DELETE, "WIP", new T { id = id}, getTableName());
